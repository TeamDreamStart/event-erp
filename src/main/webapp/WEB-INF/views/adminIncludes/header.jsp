...
<ul
	...
	<li class="nav-item"><a class="nav-link"
		href="/admin/event-manage"> <i class="fas fa-fw fa-table"></i> <span>Event
				Manage</span></a></li>
	<li class="nav-item"><a class="nav-link"
		href="/admin/reservation-manage"> <i class="fas fa-fw fa-table"></i>
			<span>Reservation-Payment</span></a></li>


	<c:set var="ctx" value="${pageContext.request.contextPath}" />
	<c:set var="uri" value="${pageContext.request.requestURI}" />
	<c:set var="isSurvey"
		value="${fn:startsWith(uri, ctx.concat('/admin/surveys'))}" />
	<!-- Survey Manage -->
	<li class="nav-item ${isSurvey ? 'active' : ''}"><a
		class="nav-link collapsed" href="#" data-toggle="collapse"
		data-target="#collapseSurvey"
		aria-expanded="${isSurvey ? 'true' : 'false'}"
		aria-controls="collapseSurvey"> <i class="fas fa-fw fa-poll"></i>
			<span>Survey Manage</span>
	</a>
		<div id="collapseSurvey" class="collapse ${isSurvey ? 'show' : ''}"
			aria-labelledby="headingSurvey" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<h6 class="collapse-header">Surveys</h6>
				<a
					class="collapse-item ${uri == ctx.concat('/admin/surveys') ? 'active' : ''}"
					href="<c:url value='/admin/surveys'/>">Survey List</a> <a
					class="collapse-item ${uri == ctx.concat('/admin/surveys/form') ? 'active' : ''}"
	...
	<li class="nav-item"><a class="nav-link" href="/admin/customers">
			<i class="fas fa-fw fa-table"></i> <span>Customers</span>
	</a></li>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown no-arrow mx-1"><a
					...
					aria-haspopup="true" aria-expanded="false"> <i
						...
						class="badge badge-danger badge-counter"> <!-- Qna에 답변완료 없는 글 갯수 -->100
					</span>
				</a> <!-- Dropdown - Messages -->
					<div
						class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
						...
						</a> <a class="dropdown-item text-center small text-gray-500" href="#">답변하러
							가기</a>
					</div></li>
