		...
		<div class="container">
			...
			<div class="main-event-section">
				<div class="event-detail-info">
					...
					<a href="/events/${event.eventId }/reservations"
						class="reserve-btn">바로 예약하기</a>
				</div>
...
<figcaption class="explain">어쩌구저쩌구</figcaption>
			...
			<div class="map-section">
				<h3>오시는 길</h3>
				<div id="map"
					style="width: 100%; height: 400px; border: 1px solid #ccc; border-radius: 8px;"></div>
			...
			<main>
				...
				<script>
					(function() {
						...
						const map = new kakao.maps.Map(document
								.getElementById('map'), {
							center : new kakao.maps.LatLng(hasLatLng ? lat
									: 37.5665, hasLatLng ? lng : 126.9780),
							level : 3
						});
