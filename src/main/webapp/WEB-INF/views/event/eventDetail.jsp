...
.event-detail-info .detail-during-date, .event-detail-info .detail-location,
	.event-detail-info .detail-capacity, .event-detail-info .detail-status
	{
	gap: 12px;
	font-weight: bold;
}

.event-detail-info p:not(.detail-during-date, .detail-location,
	.detail-capacity, .detail-status) {
	font-weight: normal;
	margin-top: 0;
}
