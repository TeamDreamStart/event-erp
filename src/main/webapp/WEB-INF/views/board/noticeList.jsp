		...
		<div class="text-center">
			<ul class="pagination">
				<c:if test="${pageVO.prev }">
					<li><a href="/notices?page=1&keyword=${keyword }">&laquo;&laquo;</a></li>
					<li><a href="/notices?page=${pageVO.startPage-1}&keyword=${keyword }">&laquo;</a></li>
				</c:if>
				<c:forEach begin="${pageVO.startPage }" end="${pageVO.endPage }"
					var="idx">
					<li
						class=<c:out value="${pageVO.cri.page==idx? 'active':''}"></c:out>>
						<a href="/notices?page=${idx }&keyword=${keyword }">${idx }</a>
					</li>
				</c:forEach>
				<c:if test="${pageVO.next && pageVO.endPage > 0 }">
					<li><a href="/notices?page=${pageVO.endPage+1 }&keyword=${keyword }">&raquo;</a></li>
