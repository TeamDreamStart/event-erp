...
<body>
		...
		<div class="container">
			...
			<div class="content-area">
				...
				<div class="info-box">
					<h3>예약 정보</h3>
					<div class="info-row">
						<span class="info-label">예약번호</span> <span class="info-value">${reservationDTO.reservationId}</span>
					</div>
					<div class="info-row">
					...
					<div class="info-row">
						<span class="info-label">인원</span> <span class="info-value">${reservationDTO.headCount}</span>
					</div>
					<div class="info-row">
						<span class="info-label">예약상태</span> <span class="info-value">${reservationDTO.reservationStatus}</span>
					</div>
					<!-- <div class="info-row">
    ...
    <div class="info-row">
    	...
    	취소된 예약입니다.
						...
						<button onclick="location.href='/my-info/${reservationDTO.userId}'" class="btn-move">나의예약목록</button>
