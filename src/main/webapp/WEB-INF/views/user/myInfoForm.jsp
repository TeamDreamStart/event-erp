    ...
    <div class="info-box">
        <form onsubmit="return validateForm(event)" action="#" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="email" name="email" class="form-input-box email-input" value="qwertyuiop@naver.com" onblur="checkEmailFormat(this)">
            </div>

            <div class="form-group">
                <label class="form-label" for="name">이름*</label>
                <input type="text" id="name" name="name" class="form-input-box" required>
            </div>
