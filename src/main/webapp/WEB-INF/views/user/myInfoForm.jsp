...
.form-input-box:invalid:not(:placeholder-shown),
...
<div class="container">
    ...
    <div class="info-box">
        <form onsubmit="return validateForm(event)" action="/my-info/${userDTO.userId}/update" method="post">
            <div class="form-section-title">기본 정보</div>
            <input type="hidden" id="userId" name="userId" value="${userDTO.userId}">

            <div class="form-group">
                <label class="form-label" for="email">이메일 (변경 불가)</label>
                <input type="text" id="email" name="email" class="form-input-box email-input" value="${userDTO.email}" onblur="checkEmailFormat(this)">
            </div>

            <div class="form-group">
                <label class="form-label" for="name">이름*</label>
                <input type="text" id="name" name="name" class="form-input-box" value="${userDTO.name}" required>
            </div>

            <div class="form-group" id="phone-group">
                <label class="form-label" for="phone">전화번호*</label>
                <input type="text" id="phone" name="phone" value="${userDTO.phone}"
                ...
                <span class="help-text">'-'를 포함하여 000-0000-0000 형식으로 입력해 주세요.</span>
                <span class="error-message" id="phone-error">전화번호 형식이 올바르지 않습니다. (예: 000-0000-0000)</span>
            </div>
    </div>
    ...
    <div class="info-box" style="margin-bottom: 140px;">
            ...
            <div class="form-group">
                ...
                <input type="password" id="currentPassword" name="currentPassword" class="form-input-box" placeholder="현재 비밀번호를 입력하세요">
                <input type="hidden" name="existingPassword" value="${userDTO.password}">
            </div>

            <div class="form-group">
                <label class="form-label" for="newPassword">새 비밀번호</label>
                <input type="password" id="newPassword" name="newPassword" class="form-input-box" placeholder="새 비밀번호를 입력하세요">
            </div>

            <div class="form-group">
                <label class="form-label" for="confirmPassword">새 비밀번호 확인</label>
                <input type="password" id="confirmPassword" name="confirmPassword" class="form-input-box" placeholder="새 비밀번호를 다시 입력하세요">
            </div>
