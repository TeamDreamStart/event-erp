...
/* 가장 좁을 때 제목만 남기고 최대한 정리 */
@media ( max-width : 600px) {
	.col-created-at, .col-small:not(.col-action) {
		display: none
	}
}
...
<body>
	<div class="page">
		...
		<div
			...
			<form method="post"
				action="${pageContext.request.contextPath}/admin/surveys/form"
				...
				<button type="submit" class="btn"
					style="background: #111827; color: #fff; border: 0; border-radius: 10px; height: 38px; padding: 0 14px; font-weight: 700;">
					템플릿 복제하기</button>
			</form>
			...
			<table id="tbl">
				<thead>
					<tr>
						...
						<th class="center col-small col-action">상세</th>
					</tr>
				</thead>
				...
				<tbody>
					<c:forEach var="s" items="${templateList}">
						<tr class="pinned-row">
							...
							<td class="center col-small col-action"><a class="page-btn"
