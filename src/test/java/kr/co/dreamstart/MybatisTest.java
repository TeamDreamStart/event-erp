...
import static org.junit.Assert.*; // 자주 사용할거라서 static선언
...
public class MybatisTest {
	...
	public void testFactory() {
		assertNotNull("sqlFactory is Null", sqlFactory); // 판정
...
//			assertNotNull("list is Null", list); // null 인지 확인
//			assertFalse("list is empty", list.isEmpty()); // 비어 있는지 확인
